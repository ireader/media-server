...
enum
{
	RTMP_CONTROL_EVENT_STREAM_BEGIN		= 0,
	RTMP_CONTROL_EVENT_STREAM_EOF		= 1,
	RTMP_CONTROL_EVENT_STREAM_DRY		= 2,
	RTMP_CONTROL_EVENT_SET_BUFFER_LENGTH= 3,
	RTMP_CONTROL_EVENT_STREAM_IS_RECORD	= 4,

	RTMP_CONTROL_EVENT_PING_REQUEST		= 6,
	RTMP_CONTROL_EVENT_PING_RESPONSE	= 7,
};
